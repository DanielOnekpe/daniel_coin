...
from daniel_coin.messages import BaseSchema
from daniel_coin.utils import get_external_ip
...
class Server:
    ...
    async def get_external_ip(self):
        # Finds our "external IP" so that we can advertise it to our peers
    ...
    async def handle_connection(self, reader: StreamReader, writer: StreamWriter):
        ...
        while True:
            try:
                ...
                # Lets add the peer to our connection pool
        ...
        # The connection has closed. lets clean up
        writer.close()
